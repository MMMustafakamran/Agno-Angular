...
[Thread authorization](/angular/agno/auth#thread-authorization).
</Callout>
...
See [Auth](/angular/agno/auth) for the full authentication guide and
[Thread authorization](/angular/agno/auth#thread-authorization) for the ownership map this
example assumes.
