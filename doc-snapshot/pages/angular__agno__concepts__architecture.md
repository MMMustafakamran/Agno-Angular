...
7. Threads, persistence, and realtime sync (when configured) are mediated by [CopilotKit Intelligence](/angular/agno/intelligence/overview) — the platform backend that sits beside the runtime.
