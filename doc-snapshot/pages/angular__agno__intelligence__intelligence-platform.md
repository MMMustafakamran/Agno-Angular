...
A thread is the saved conversation for one user in one project. Read [Rich Threads](/angular/agno/guides/threads-memory-attachments-headless) for the product. Read [how a thread is saved](/angular/agno/intelligence/threads-explained) for replay and sync.
...
Self-hosted changes who operates the platform. The frontend integration stays the same. Moving from cloud-hosted to self-hosted is available on the Team Self-hosted plan or the Enterprise plan. See [Plans](/angular/agno/intelligence/plans).
...
- [Overview](/angular/agno/intelligence/overview) lists each feature on its own page.
- [Cloud-hosted](/angular/agno/intelligence/managed-intelligence-platform) creates the project and the API key.
- [Self-host on Kubernetes](/angular/agno/intelligence/self-hosting) installs the platform in your cluster.
- [How a thread is saved](/angular/agno/intelligence/threads-explained) covers replay and sync.
