...
`copilotkit skills download` remains supported for inspection, offline use, and unsupported frameworks. See the [Learning guide](/angular/agno/learning) for the manual workflow.
