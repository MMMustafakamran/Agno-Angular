...
conversation, read [Threads & Persistence Architecture](/angular/agno/intelligence/threads-explained)
instead.
...
<Steps>
  <Step>
    ...
    Complete the [Intelligence quickstart](/angular/agno/intelligence/quickstart#set-it-up-manually). That page signs you in with the CLI, selects the project, and configures server-side user identity. Your existing app and agent stay in place.
  </Step>
...
<a href="/angular/agno/guides/threads-memory-attachments-headless">Threads, memory, attachments, and headless UI</a>
...
- **Threads:** [Threads & Persistence Architecture](/angular/agno/intelligence/threads-explained), the
  persistence model for a single conversation
- **Platform:** [CopilotKit Intelligence](/angular/agno/intelligence/overview), where
  memory sits among the other pillars
- **Self-hosting:** [Self-hosting Intelligence](/angular/agno/intelligence/self-hosting),
