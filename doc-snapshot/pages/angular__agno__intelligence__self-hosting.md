...
Before starting, make sure the following are in place. [CopilotKit Intelligence architecture](/angular/agno/intelligence/intelligence-platform) explains the application/runtime/platform layers in more depth.
...
- **Platform architecture:** [CopilotKit Intelligence architecture](/angular/agno/intelligence/intelligence-platform) — runtime/platform architecture, project boundaries, threads, and realtime sync
- **CopilotKit Intelligence overview:** [CopilotKit Intelligence](/angular/agno/intelligence/overview) — features, hosting options, and where to go next
