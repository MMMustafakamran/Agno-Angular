...
The walkthrough begins with User Memories, a separate Intelligence capability, then shows an expense-review workflow becoming a reusable Skill.
...
<Steps>
  <Step>
    ...
    Complete the [Intelligence quickstart](/angular/agno/intelligence/quickstart), then send a message and confirm that it appears in [Rich Threads](/angular/agno/guides/threads-memory-attachments-headless). Open your project in [CopilotKit Intelligence](https://dashboard.operations.copilotkit.ai/) and confirm that Learning is available.
