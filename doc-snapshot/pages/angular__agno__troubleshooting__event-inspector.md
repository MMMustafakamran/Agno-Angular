...
<Callout type="info">
  ...
  [Inspector](/angular/agno/inspector#enable-or-repair-intelligence) for the setup flow.
</Callout>
...
<Callout type="warning">
  ...
  [Inspector](/angular/agno/inspector), which reads the events on the client.
</Callout>
...
<Callout type="info">
  For application-level debugging, use the [Angular troubleshooting guide](/angular/agno/guides/troubleshooting). For component and tool-renderer examples, use the [Angular feature examples](/angular/agno/features).
</Callout>
