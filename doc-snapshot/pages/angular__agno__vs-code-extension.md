...
The hook preview is not the Angular authoring surface. Browse <a
href="/angular/agno/features">Angular feature examples</a> instead: each supported
feature links to the runnable standalone component and its closest typed API
reference. The A2UI Catalog and AG-UI Inspector sections below remain
applicable.
...
<Callout type="info">
  Full walkthrough, event-type color reference, and production guard details: [AG-UI Event Inspector](/angular/agno/troubleshooting/event-inspector).
</Callout>
