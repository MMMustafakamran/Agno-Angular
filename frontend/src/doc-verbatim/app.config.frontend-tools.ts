...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    provideCopilotKit({
      ...
      openGenerativeUI: {
        // DOC VERBATIM: the guide's line, with no cast. This file is only
        // compiled under `--configuration doc-frontend-tools` (angular.json
        // fileReplacements swaps it in for src/app/app.config.ts), so the
        // normal build keeps the cast and keeps working. Expect TS2322 here.
        // https://docs.copilotkit.ai/angular/agno/guides/frontend-tools-generative-ui
